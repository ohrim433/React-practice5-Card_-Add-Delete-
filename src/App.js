    ...
    return (
        <div className="App">
            ...
            {data ? data.map(i => {
                // console.log('User');
                // console.log(i);
                return <Card user={i} key={i.id} handleDeleteCard={this.handleDeleteCard} countHandler={this.countHandler
                }/>}) : "Loading"}
            <Addcard onAddBtnClickHandler={this.handleAddCard} data={this.state.data}/>
        </div>
    );
  }
}
